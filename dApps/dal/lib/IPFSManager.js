...
export class IPFSManager {
     ...
     */
    async uploadROCrateMetadata(metadata, projectId) {
        const file = {
     ...
     */
    async uploadCWLWorkflow(workflow, projectId) {
        const file = {
        ...
        return new Promise((resolve, reject) => {
            ...
            reader.onload = async (e) => {
                ...
                try {
                    const ipfsFile = {
                        name: file.name,
                        content: (_a = e.target) === null || _a === void 0 ? void 0 : _a.result,
                        type: file.type
                    };
     ...
     */
    async uploadProjectBundle(roCrateMetadata, workflow, projectId, additionalFiles) {
        try {
     ...
     */
    async uploadToBrowserIPFS(file) {
     ...
     */
    async uploadDirectory(files, dirName) {
     ...
     */
    async downloadFile(hash, timeout = 10000) {
...
//# sourceMappingURL=IPFSManager.js.map